...
public class UsuarioDAO {
	...
	public String usuarioAtivo(UsuarioBean usuario) throws ProjetoException {

		String ativo = "";

		String sql = "select ativo from acl.usuarios where cpf = ? and senha = ?";
	...
	public Boolean cadastrar(UsuarioBean usuario) throws ProjetoException {
		...
		try {
			...
			CallableStatement cs = conexao
					.prepareCall("{ ? = call acl.gravausuario(?, ?, ?, ?, ?, ?, ?, ?, ?) }");
