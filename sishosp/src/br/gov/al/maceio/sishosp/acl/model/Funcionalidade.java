...
public class Funcionalidade implements Serializable {
	...
	public Funcionalidade(Long id, String descricao, String icone, String url,
			String action, String onclick, String codigo, String indice,
			String tipo, boolean ativo, Integer idPermissao, Integer idRotina,
			String desRotina, Integer idSistema, String descSistema,
			String siglaSistema, Integer idRecSistema,
			List<Integer> listaSistemas, String indiceAux) {
		this.id = id;
