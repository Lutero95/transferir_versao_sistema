...
public class LogBean {
	...
	public LogBean(Long idFuncionario, String descricao, String rotina, Boolean alteracaoRealizada) {
	...
	public Boolean getAlteracaoRealizada() {
		return alteracaoRealizada;
	}

	public void setAlteracaoRealizada(Boolean alteracaoRealizada) {
		this.alteracaoRealizada = alteracaoRealizada;
	}
}
