...
public class AgendaDAO extends VetorDiaSemanaAbstract {
	...
	public int verQtdMaxAgendaDataEspecificaPorTipoAtendimento(AgendaBean agenda) throws ProjetoException {
		...
		try {
			...
			stm.setDate(3, new java.sql.Date(agenda.getDataAtendimento().getTime()));
	...
	public boolean buscarDataEspecifica(AgendaBean agenda) throws ProjetoException {
		...
		String sqlEquiAva = "select e.id_configagenda \n" + "from hosp.config_agenda_equipe e \n"
				...
				+ "where e.codequipe = ? and d.data_especifica = ? and d.turno = ?  and t.primeiroatendimento is true";
	...
	public ArrayList<String> listaDiasDeAtendimetoParaPacienteInstituicao(Integer idPacienteInstituicao)
			throws ProjetoException {
	...
	public ArrayList<String> listaDiasDeAtendimetoParaPacienteInstituicaoIhProfissional(Integer idPacienteInstituicao,
