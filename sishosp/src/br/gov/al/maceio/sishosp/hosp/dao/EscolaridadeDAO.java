...
public class EscolaridadeDAO {
	...
	// COMEÇO DO CODIGO
            ...
            public Boolean cadastrar(EscolaridadeBean escolaridade) throws ProjetoException {
                ...
                String sql = "insert into hosp.escolaridade (descescolaridade, dtacadastro)"
                ...
                //returning id_paciente
                    try {
                        ...
                        stmt.setString(1, escolaridade.getDescescolaridade().toUpperCase().trim());
            ...
            public EscolaridadeBean buscaescolaridadecodigo (Integer i) throws ProjetoException {
            ...
            public List<EscolaridadeBean> buscaescolaridade (String s) throws ProjetoException {
