...
public class EncaminhamentoDAO {
	...
	// COMEÇO DO CODIGO
            ...
            public Boolean cadastrar(EncaminhamentoBean encaminhamento) throws ProjetoException {
            ...
            public Boolean alterar(EncaminhamentoBean encaminhamento) throws ProjetoException {
            ...
            public Boolean excluir(EncaminhamentoBean encaminhamento) throws ProjetoException {
            ...
            public EncaminhamentoBean buscaencaminhamentocodigo (Integer i) throws ProjetoException {
        		System.out.println("buscaencaminhamentocodigo");
            ...
            public List<EncaminhamentoBean> buscaencaminhamento(String s) throws ProjetoException {
            	System.out.println("buscaencaminhamento");
            			PreparedStatement ps = null;
            			conexao = ConnectionFactory.getConnection();
