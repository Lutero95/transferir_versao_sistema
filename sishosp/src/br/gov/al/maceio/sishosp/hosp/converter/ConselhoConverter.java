...
@FacesConverter(value = "conConselho")
public class ConselhoConverter implements Converter {
    ...
    public Object getAsObject(FacesContext contet, UIComponent component,
        ...
        try {
            ...
            return conselhoDao.buscaConselhoPorId(id);
        } catch (Exception e) {
            //comentado walter erro log ex.printStackTrace();
            throw new ConverterException(new FacesMessage(
                    FacesMessage.SEVERITY_ERROR, "Conselho não válido", ""));
        }
    }
    ...
    public String getAsString(FacesContext contet, UIComponent component,
        ...
        if (value == null || value.equals(""))
            return null;
        return String.valueOf(((ConselhoBean) value).getId());
    }
}