...
public class ProcedimentoController implements Serializable {
    ...
    public void excluirProcedimento() throws ProjetoException {
        ...
        if (excluiu == true) {
            JSFUtil.adicionarMensagemSucesso("Procedimento excluÃ­do com sucesso!", "Sucesso");
    ...
    public void addCid() {
        ...
        if (proc.getListaCid().size() == 0 && cid.getIdCid() > 0) {
            ...
            if (existe == false) {
                ...
                JSFUtil.adicionarMensagemAdvertencia("Essa CID jÃ¡ foi adicionado!", "AdvertÃªncia");
            }
        }
        cid = new CidBean();
    }
    ...
    public void addCbo() {
        ...
        if (proc.getListaCbo().size() == 0 && cbo.getCodCbo() > 0) {
            ...
            if (existe == false) {
                ...
                JSFUtil.adicionarMensagemAdvertencia("Essa CBO jÃ¡ foi adicionado!", "AdvertÃªncia");
            }
        }
        cbo = new CboBean();
    }
    ...
    public void addRecurso() {
        ...
        if (proc.getListaRecurso().size() == 0 && recurso.getIdRecurso() > 0) {
            ...
            if (existe == false) {
                ...
                JSFUtil.adicionarMensagemAdvertencia("Essa Recurso jÃ¡ foi adicionado!", "AdvertÃªncia");
            }
        }
        recurso = new RecursoBean();
    }
