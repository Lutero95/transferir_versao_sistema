...
public class AlteracaoPacienteDAO {
		...
		//	ArrayList<RemocaoProfissionalEquipe> listaProfissionaisRemovidosEquipe =  gerenciarPacienteDAO.listaAtendimentosQueTiveramRemocaoProfissionalEquipePeloIdPacienteInstituicao(id_paciente, conexao) ;
			...
			*/
			...
			if(!VerificadorUtil.verificarSeObjetoNuloOuZero(insercao.getLaudo().getId())) {
				List<Integer> listaIdAtendimento1 = listaIdAtendimentos1PorPacienteInstituicao(insercao.getLaudo().getPaciente().getId_paciente(), conexao);
	...
	public List<Integer> listaIdAtendimentos1PorPacienteInstituicao(Integer idPaciente, Connection conexao)
