 ...
 *       &lt;sequence&gt;
 *         &lt;element name="codigo" type="{http://servicos.saude.gov.br/schema/sigtap/procedimento/v1/procedimento}CodigoProcedimentoType"/&gt;
...
@XmlType(name = "BaseProcedimentoType", propOrder = {
    "codigo",
    "nome"
})
@XmlSeeAlso({
    ProcedimentoType.class
})
public class BaseProcedimentoType {
