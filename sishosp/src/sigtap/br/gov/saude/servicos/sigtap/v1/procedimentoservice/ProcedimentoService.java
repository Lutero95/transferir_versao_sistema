 ...
 * 2020-03-18T11:58:01.010-03:00
 * Generated source version: 3.3.5
 *
 */
@WebServiceClient(name = "ProcedimentoService",
                  wsdlLocation = "https://servicos.saude.gov.br/sigtap/ProcedimentoService/v1?wsdl",
...
public class ProcedimentoService extends Service {
    ...
    public final static QName ProcedimentoServiceSOAP11Port = new QName("http://servicos.saude.gov.br/sigtap/v1/procedimentoservice", "ProcedimentoServiceSOAP11Port");
    ...
    static {
        URL url = null;
        try {
            url = new URL("https://servicos.saude.gov.br/sigtap/ProcedimentoService/v1?wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(ProcedimentoService.class.getName())
                .log(java.util.logging.Level.INFO,
                     "Can not initialize the default wsdl from {0}", "https://servicos.saude.gov.br/sigtap/ProcedimentoService/v1?wsdl");
        }
        WSDL_LOCATION = url;
    }
     ...
     */
    @WebEndpoint(name = "ProcedimentoServiceSOAP11Port")
    public ProcedimentoServicePortType getProcedimentoServiceSOAP11Port() {
        return super.getPort(ProcedimentoServiceSOAP11Port, ProcedimentoServicePortType.class);
    }
     ...
     */
    @WebEndpoint(name = "ProcedimentoServiceSOAP11Port")
    public ProcedimentoServicePortType getProcedimentoServiceSOAP11Port(WebServiceFeature... features) {
        return super.getPort(ProcedimentoServiceSOAP11Port, ProcedimentoServicePortType.class, features);
    }
